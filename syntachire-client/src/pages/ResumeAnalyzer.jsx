    ...
    <div className="min-h-screen bg-slate-50/80 px-4 py-12 sm:px-6 lg:px-8 text-slate-800 antialiased">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-base sm:text-lg text-slate-600 font-normal leading-relaxed">
        ...
        <div className="grid gap-8 lg:grid-cols-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-3 text-sm font-medium text-slate-900 transition focus:border-blue-500 focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-blue-500/20"
              />
            </div>
            ...
            <div
              ...
              className={`group relative flex cursor-pointer flex-col items-center justify-center rounded-3xl border-2 border-dashed p-8 text-center transition-all duration-300 ${
                dragActive
                  ...
                  : "border-slate-300 bg-white hover:border-blue-400 hover:bg-blue-50/20 shadow-xs hover:shadow-md"
              }`}
            >
              <input
                ref={inputRef}
              ...
              />
              <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 transition-transform duration-300 group-hover:scale-110 group-hover:bg-blue-600 group-hover:text-white shadow-xs">
                <UploadCloud className="h-8 w-8" />
              </div>
              <p className="text-base font-bold text-slate-800">
                Drag resume here, or <span className="text-blue-600 underline decoration-blue-300">browse</span>
              </p>
            ...
            {/* Selected File Card */}
            {file && (
              <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-4 shadow-xs animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            {/* Error Message Alert */}
            {error && (
              <div className="flex items-center gap-3 rounded-2xl bg-red-50 p-4 text-sm font-semibold text-red-700 border border-red-200">
            ...
            <button
              ...
              className="group relative flex w-full items-center justify-center gap-2.5 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 py-4 text-base font-bold text-white shadow-md shadow-blue-500/25 transition-all duration-300 hover:from-blue-700 hover:to-indigo-700 hover:shadow-lg hover:shadow-blue-500/35 active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-50"
            >
              {analyzing ? (
                <>
            ...
            <div className="flex items-center justify-center gap-6 pt-1 text-xs font-bold text-slate-400">
          ...
          <div className="lg:col-span-7">
            <div className="min-h-[460px] rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-xs">
              ...
              {!result && !analyzing && (
                <div className="flex h-full min-h-[380px] flex-col items-center justify-center text-center">
                  ...
                  <h3 className="text-xl font-extrabold text-slate-800">No Analysis Yet</h3>
                  <p className="mt-2 max-w-sm text-sm font-medium text-slate-500 leading-relaxed">
              ...
              {analyzing && (
                <div className="flex h-full min-h-[380px] flex-col items-center justify-center text-center">
                  ...
                  <h3 className="text-xl font-extrabold text-slate-800">Evaluating Profile</h3>
                  <p className="mt-2 max-w-sm text-sm font-medium text-slate-500 leading-relaxed">
                    Scanning your resume text against benchmark requirements for <span className="font-bold text-blue-600">{targetRole}</span>...
                  </p>
                </div>
              )}
              ...
              {result && !analyzing && (
                <div className="space-y-8 animate-in fade-in duration-500">
                  ...
                  <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start border-b border-slate-100 pb-7">
                    <ScoreRing score={result.atsScore ?? 0} />
                    <div className="flex-1 text-center sm:text-left">
                      <div className="flex items-center justify-center sm:justify-between gap-2">
                        <h3 className="text-xl font-black text-slate-900">Analysis Summary</h3>
                        <span className="text-xs font-bold bg-blue-50 text-blue-700 px-3 py-1 rounded-full border border-blue-200">
                          {targetRole}
                        </span>
                      </div>
                      <p className="mt-2.5 text-sm sm:text-base leading-relaxed font-normal text-slate-600">
                  ...
                  {result.extractedSkills?.length > 0 && (
                    <div>
                      <h4 className="mb-3 flex items-center gap-2 text-sm font-black uppercase tracking-wider text-slate-900">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {result.extractedSkills.map((skill, idx) => (
                          <span
                            key={idx}
                            className="inline-flex items-center rounded-xl bg-emerald-50 px-3.5 py-2 text-xs font-bold text-emerald-800 ring-1 ring-inset ring-emerald-600/20 hover:bg-emerald-100 transition cursor-default"
                          >
                            {skill}
                          </span>
                        ))}
                    ...
                    <div>
                      ...
                      <ul className="space-y-2.5">
                        {result.suggestions.map((item, idx) => (
                          <li key={idx} className="flex items-start gap-3 text-sm font-medium text-slate-700 bg-amber-50/60 p-3.5 rounded-2xl border border-amber-200/70 leading-relaxed hover:bg-amber-50 transition">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {result.missingSkills.map((kw, idx) => (
                          <span
                            key={idx}
                            className="rounded-xl bg-slate-100 px-3.5 py-2 text-xs font-bold text-slate-700 border border-slate-200 hover:border-slate-300 transition cursor-default"
                          >
                            + {kw}
                          </span>
                        ))}
